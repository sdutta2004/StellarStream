...
export const STELLAR_CONFIG: StellarConfig = {
  ...
  contractId:
    ...
    "CBWUQRGPLGVWNXSUNO7GGET4RMWQBYQRGGJFLLBUHTG6JYN3LUZOSCHQ",
  rewardTokenId:
    process.env.NEXT_PUBLIC_STRM_TOKEN_CONTRACT_ID ||
    process.env.NEXT_PUBLIC_REWARD_TOKEN_CONTRACT_ID ||
    "CBLCBZNJBLS3SSMVZUAPIK53QOCPOYXMJPMS3L7TZSFH7SGKRWEGM66M",
};
...
export const DEPLOYER_ADDRESS =
  ...
  "GBVLCPD3N67ZMJ7KEMN577ZJLNZLPD77VWYLTYO56QPXUPH7V4B4CMZO";
